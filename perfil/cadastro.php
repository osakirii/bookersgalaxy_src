...
<<<<<<< HEAD
            ...
            <input type="hidden" name="action" value="register">
                ...
                <p>Li e acordo com os Termos <input type="checkbox" name="checkbox" required id="checkbox"></p>
            </div>
            <div class="btns">
...
=======
                    <h3>NOVA CONTA</h3>
                <div class="Caixas">
                    <p> Nome de Usuário<br><input name="txtUsuario" type="text" size="20"></p>
                ...
                <ul>
                    ...
                    <a href="login_cad.php"><button class="BTverde" type="button">Próximo</button></a>
                </ul>
            </div>
        </div>
    </main>
