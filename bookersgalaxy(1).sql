...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Nov-2024 às 18:51
...
--
-- Estrutura da tabela `arquivossite`
--
...
--
-- Extraindo dados da tabela `arquivossite`
--
...
--
-- Estrutura da tabela `imagens_editoras`
--
...
--
-- Extraindo dados da tabela `imagens_editoras`
--
...
--
-- Índices para tabela `arquivossite`
--
...
--
-- Índices para tabela `enderecos_cliente`
--
...
--
-- Índices para tabela `imagens_editoras`
--
...
--
ALTER TABLE `editora`
  MODIFY `id_editora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `livros`
  MODIFY `ID_livro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
