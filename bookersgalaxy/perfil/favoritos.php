...
try {
    if ($userId !== null) {
        $stmt = $con->prepare("
        SELECT livro.id_livro, livro.titulo, livro.autor, livro.preco, imagens.caminho AS imagem_caminho
        FROM livro
        INNER JOIN favoritos ON favoritos.id_livro = livro.id_livro
...
<div class="box_carousels">
            ...
            <div class="box_carousel">
                ...
                <span id="seta_direita" class="material-symbols-outlined" style="margin-right:340px;"  onclick="moveCarousel(1)">
                    arrow_forward
                </span>
            </div>
